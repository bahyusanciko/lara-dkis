...
<div class="container-fluid" style="background-color: #F5F5F5; padding  :10px; margin-top:50px; width: 95%;">
    ...
    <div class="row">
        <div class="col-sm">
            <div class="card">
              <h5 class="card-header"> <strong> Semua Laporan Pengajuan Layanan PSE: {{ $cLaporans[4] }} </strong> </h5>
              <div class="card-body">
                <br>
    ...
    <div class="row">
        ...
        <h3><strong>Laporan LPSE</strong></h3>
            ...
            <table class="table table-striped table-bordered table-hover" id="tabelLaporan">
                ...
                @foreach ($data as $datas)
                    <tr>
                        ...
                        <th scope="col">{{ $datas->tanggal_laporan }}</th>
                        <th scope="col">{{ $datas->nip }}</th>
                        <th scope="col">{{ $datas->nama }}</th>
                        <th scope="col">{{ $datas->no_hp }}</th>
                        <th scope="col">
                            <a href="{{ url('storage/lpse/'.$datas->lpse['attachment']) }}">Formulir LPSE</a>
                        </th>
