...
<div class="container-fluid" style="background-color: #F5F5F5; padding  :10px; margin-top:50px; width: 95%;">
    ...
    <div class="row">
        <div class="col-sm">
            <div class="card">
              <h5 class="card-header"> <strong> Semua Laporan Pengajuan Pembuatan Email: {{ $cLaporans[4] }} </strong> </h5>
              <div class="card-body">
                <br>
    ...
    <div class="row">
        ...
        <h3><strong>Pengajuan Pembuatan Email</strong></h3>
        <br>
            @if (@count($data) == 0)
            ...
            <table class="table table-striped table-bordered table-hover" id="tabelLaporan">
                ...
                @foreach ($data as $datas)
                    <tr>
                        ...
                        <th scope="col">{{ $datas->pembuatan_email['nama_SKPD'] }}</th>
                        <th scope="col">
                          @if (is_null($datas->pembuatan_email['attachment']) == 0)
                            <a href="{{ url('storage/permohonan_aplikasi/'.$datas->pembuatan_email['attachment']) }}">surat permohonan akun</a>
                          @else
                            <p>&times;</p>
                          @endif
                        </th>
