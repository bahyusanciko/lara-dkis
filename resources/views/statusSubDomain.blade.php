...
<div class="container-fluid" style="background-color: #F5F5F5; padding  :10px; margin-top:50px; width:95%;">
    ...
    <div class="row">
        <div class="col-sm">
            <div class="card">
              <h5 class="card-header"> <strong> Semua Laporan Pengajuan SubDomain: {{ $cLaporans[4] }} </strong> </h5>
              <div class="card-body">
                <br>
    ...
    <div class="row">
        ...
        <h3><strong>Laporan SubDomain</strong></h3>
        <!-- Ini mending nama atau NIP -->   
            ...
            <table class="table table-striped table-bordered table-hover" id="tabelLaporan">
                ...
                @foreach($data as $datas)
                    <tr>
                        ...
                        <th scope="col">{{ $datas->subdomain['email_domain'] }}</th>
                        <th scope="col">
                            <a href="{{ url('storage/SubDomain/'.$datas->subdomain['email_domain'].'/'.$datas->subdomain['surat_pengajuan']) }}">surat pengajuan</a><br>
                            <hr style="width: 100% !important;">
                            <a href="{{ url('storage/SubDomain/'.$datas->subdomain['email_domain'].'/'.$datas->subdomain['surat_tugas']) }}">surat tugas</a> <br>
                            <hr style="width: 100% !important;">
                            <a href="{{ url('storage/SubDomain/'.$datas->subdomain['email_domain'].'/'.$datas->subdomain['surat_kpe']) }}">surat KPE</a>
                        </th>
